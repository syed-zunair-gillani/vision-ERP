  ...
  return (
    <article className='shadow2 rounded-[20px] group'>
          ...
          <div className='p-4 px-6'>
               <h2 className='text-[17px] font-semibold text-[#01253A]'>How AI is giving employees more autonomy over their assignments!</h2>
               ...
               <Link href="#" className='text-[#3F3F3F] font-semibold group-hover:text-[#00619D]'>Read More</Link>
          </div>
    </article>
  )
}
